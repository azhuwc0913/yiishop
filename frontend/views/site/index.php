<?php
	...
	$this->title = '京西商城';
	?>
<?= Html::cssFile('@web/style/index.css');?>
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						...
						<li>
							<dl>
								<dt><a href="#"><?= showImage($v['sm_logo'])?></a></dt>
								<dd><a href="#"><?= Html::encode($v['goods_name'])?></a></dd>
								<dd><span>售价：</span><strong> ￥<img src="<?php echo $v['sm_logo']?>"></strong></dd>
							</dl>
						</li>
						<?php endforeach;?>
						<li>
